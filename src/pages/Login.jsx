...
const Login = ({ onLogin }) => {
  const [email, setEmail] = useState('test@growie.com');
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-growie-dark mb-3">
              Welcome back to Growie <span className="inline-block">🌱</span>
            </h1>
            <p className="text-[#526B5F] text-lg">
              Login to continue growing your savings effortlessly
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 text-growie-green rounded border-gray-300 focus:ring-growie-green cursor-pointer" />
                <span className="text-sm text-[#526B5F] font-medium">Remember me</span>
              </label>
              <a href="#" className="text-sm font-semibold text-growie-green hover:text-growie-dark transition-colors">
                Forgot password?
              </a>
            </div>
            ...
            <p className="text-center text-sm font-medium text-[#526B5F] mt-6">
              ...
              <Link to="/register" className="font-semibold text-growie-green hover:text-growie-dark transition-colors">
                Sign Up
              </Link>
            </p>
          </form>
